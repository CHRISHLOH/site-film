...
CREATE TABLE IF NOT EXISTS content_service.countries (
                                                         ...
                                                         iso_3166_1 VARCHAR(2) NOT NULL UNIQUE,
                                                         translations JSONB NOT NULL CHECK (jsonb_typeof(translations) = 'object')
);
CREATE INDEX IF NOT EXISTS idx_countries_iso_3166_1 ON content_service.countries(iso_3166_1);
...
CREATE TABLE IF NOT EXISTS content_service.seasons (
                                                       ...
                                                       poster_url TEXT,
                                                       release_date DATE,
                                                       episodes_count SMALLINT DEFAULT 0,
                                                       created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
                                                       updated_at TIMESTAMPTZ DEFAULT NOW(),
...
CREATE INDEX IF NOT EXISTS idx_persons_external_id ON content_service.persons(external_id);
...
CREATE TABLE IF NOT EXISTS content_service.audio_tracks (
                                                                  id BIGSERIAL PRIMARY KEY,
                                                                  language_id SMALLINT NOT NULL, -- язык озвучки
...
CREATE TABLE IF NOT EXISTS content_service.content_persons (
                                                             ...
                                                             display_order_in_content SMALLINT DEFAULT 0,
                                                             created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
                                                             updated_at TIMESTAMPTZ DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS content_service.content_countries (
                                   ...
                                   country_id SMALLINT REFERENCES content_service.countries(id),
...
CREATE TABLE IF NOT EXISTS content_service.video_file_subtitles (
                                                               id            BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                                               video_file_id      BIGINT       NOT NULL,
                                                               language_id   SMALLINT       NOT NULL, -- язык субтитров
...
CREATE TABLE IF NOT EXISTS content_service.franchises (
                                            ...
                                            sort_order SMALLINT, -- порядок внутри родительской франшизы
                                            poster_url TEXT,
...
CREATE TABLE IF NOT EXISTS content_service.franchise_watch_order_items (
                                                             ...
                                                             CONSTRAINT fk_watch_order_content FOREIGN KEY (content_id)
                                                                 REFERENCES content_service.content(id),
                                                             PRIMARY KEY (watch_order_id, content_id)
);
...
CREATE TABLE IF NOT EXISTS content_service.award_nomination_persons (
                                                          nomination_id BIGINT NOT NULL,
                                                          person_id BIGINT NOT NULL,
                                                          career_id SMALLINT REFERENCES content_service.careers(id),
...
CREATE TABLE IF NOT EXISTS content_service.content_statistics (
                                                    ...
                                                    last_processed_kafka_offset BIGINT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS content_service.translation_process(
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    content_id BIGINT NOT NULL,
    ...
    translation_status SMALLINT NOT NULL DEFAULT 1,
    created_at TIMESTAMP NOT NULL DEFAULT NOW(),
    updated_at TIMESTAMP NOT NULL DEFAULT NOW(),
    CONSTRAINT idx_content_translation_unique
        UNIQUE (content_id, content_type, field_name, source_code, target_code)
);
CREATE INDEX IF NOT EXISTS idx_translation_process ON content_service.translation_process(translation_status);


CREATE TABLE IF NOT EXISTS content_service.etl_failed_record(
