...
public class CommonAggregator {
    ...
    public CommonAggregator(PersonAggregator personAggregator, RelationshipsAggregator relationshipsAggregator, ContentTranslationMovieAggregator contentTranslationMovieAggregator)
    {
    ...
    public CommonAggregateData aggregateContent(ContentResponse movieDetails, PersonsInMovieResponseDto personsCast, DictionariesDto dictionaries) {
        ...
        return new CommonAggregateData(
                content,
                translations,
