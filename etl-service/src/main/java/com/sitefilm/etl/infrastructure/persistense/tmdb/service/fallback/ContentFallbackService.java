...
public class ContentFallbackService {
    ...
    public ContentFallbackService(ContentRepositoryPort contentRepository, FailedRecordsRepository failureRecordsRepository, FailedRecordFactory failedRecordFactory) {
        this.contentRepository = contentRepository;
        this.failureRecordsRepository = failureRecordsRepository;
        this.failedRecordFactory = failedRecordFactory;
    }

    public Long saveContentSafely(Content content) {
        try {
    ...
    public void saveTranslationsSafely(List<DataContentTranslation> translations, Long contentId, Long externalId) {
        try {
